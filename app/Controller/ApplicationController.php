...
class ApplicationController extends AppController {
	...
	public function beforeFilter() {
		...
		$this->Session->write('Application.Campaign_id', '5a0a8b5719336');
		$this->Session->write('Application.Campaign_key', 'Q37bhm6q4JZycg2CKzdp');
	...
	public function processLead(){
		...
		if($this->request->is('ajax')){
			...
			if($this->Application->validates(array('fieldList' => array('BankAccountType','BankRoutingNumber','BankAccountNumber','BankName','BankTime')))) {
				...
				$response_array['url'] = "?sitename=accesspointlending&firstname=".$firstname."&lastname=".$lastname."&email=".$email."&address=".$address."&city=".$city."&state=".$state."&zipcode=".$zipcode;
