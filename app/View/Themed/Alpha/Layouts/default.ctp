...
<html lang="en">
    <head>
      ...
      <script async src="https://www.googletagmanager.com/gtag/js?id=UA-71925930-9"></script>
      <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());
        gtag('config', 'UA-71925930-9');
      </script>
        ...
        <title>Access Point Lending - Lending The Cash You Need! </title>
  ...
  <div class="container">
      <div class="row">
          <div class="col-sm-12">
              <div id="ws_logo">
                <!-- <img src="/img/ws_logo.png" width="223" height="84" alt="" class="img-responsive"/>  -->
                <?php echo $this->Html->image('ws_logo.png', array('alt'=>'Accesspointlending', 'class'=>'img-responsive', 'width'=>'223', 'height'=>'84', 'url'=>'/')); ?>
...
<script src="https://stage.ola-memberseal.org/js/seal.js?seal=member&token=hmbwuSTSq34txkS2MLlX&sealwidth=100&sealheight=100">
</script><br />
